<nav x-data="{ open: false }" class="bg-indigo-100 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                        ...
                                        <div>
                                            @if (!empty(Auth::user()->getRoleNames()))
                                                @foreach (Auth::user()->getRoleNames() as $rol)
                                                    <span class="bg-indigo-500 text-gray-200 rounded ml-1 px-2 text-xs">
                                                        {{$rol}}
                                                    </span>
                                                @endforeach
                                            @endif
